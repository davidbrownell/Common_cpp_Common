...
# |  Generated on: 2019-12-11 11:20:55.685864
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
named_filters_TypeInfo                                                      = ClassTypeInfo(OrderedDict([ ( "glob", StringTypeInfo(min_length=1) ), ( "exclusive", BoolTypeInfo(arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('*'))
...
_named_filters_TypeInfo_Contents                                            = OrderedDict([("glob", GenericTypeInfo()), ("exclusive", GenericTypeInfo(arity=Arity.FromString('?'))), ("includes", GenericTypeInfo(arity=Arity.FromString('*'))), ("excludes", GenericTypeInfo(arity=Arity.FromString('*')))])
...
_named_filters_exclusive_TypeInfo                                           = BoolTypeInfo(arity=Arity.FromString('?'))
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def named_filters_exclusive(cls, item):
        if item in [DoesNotExist, None]:
            _named_filters_exclusive_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._named_filters_exclusive_Item(item)

        _named_filters_exclusive_TypeInfo.ValidateArity(result)
    ...
    def _named_filters_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # exclusive
        try:
            cls._ApplyOptionalAttribute(item, "exclusive", attributes, cls.named_filters_exclusive, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_named_filters_exclusive_TypeInfo, "false"))
        except:
            _DecorateActiveException("exclusive")
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"glob", "exclusive", "includes", "excludes"},
            )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _named_filters_exclusive_Item(cls, item):
        return YamlSerialization.DeserializeItem(_named_filters_exclusive_TypeInfo, item, **{})
